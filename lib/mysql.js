...
// 店铺名称、所在地区【x,y】 、详细地址、店铺头像、店铺图片、客服电话、配送时间、商家介绍
// 店铺
let shops =
    `create table if not exists shops(
       id INT NOT NULL AUTO_INCREMENT,
       name VARCHAR(20) NOT NULL COMMENT '店铺名称',
       position VARCHAR(20) NOT NULL COMMENT '所在地区【x,y】',
       address VARCHAR(30) NOT NULL COMMENT '详细地址',
       shoplogo VARCHAR(30) NOT NULL COMMENT '店铺头像',
       mobilephone VARCHAR(20) NOT NULL COMMENT '客服电话',
       summary VARCHAR(100) NOT NULL COMMENT '商家介绍',
       PRIMARY KEY ( id )
    );`
